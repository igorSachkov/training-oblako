...
let initialStore = [
    { id: 101, date: 1640239200000, name: "загрузка", members: 0, coach: "", progress: 0 }
]
...
export const jsonWasLoaded = (newEvents) => ({ type: "JSON-WAS-LOADED", newEvents})

export const getEventsThunk = () => {
    return (dispatch) => {
        fetch("https://raw.githubusercontent.com/igorSachkov/training-oblako/master/src/ReduxStore/events.json")
    .then(response => response.json())
    .then(json=> dispatch(jsonWasLoaded(json)))
    }
}